...
#define switchWidth             52
#define switchHeight            52
...
-(void)pressedBackButton:(UIButton*)sender{
    [self.delegate timePicker:self selectedDate:nil switchButton:self.onoff.on];
}
...
-(void)pressedConfirmButton:(UIButton*)sender{
    [self.delegate timePicker:self selectedDate:self.pickingDate switchButton:self.onoff.on];
}
...
-(void)updateForDate:(NSDate*)date{
   ...
   // if(!dayString) dayString = [KPUtil dayStringForDate:date];
    ...
    self.dayLabel.text = @"Daily Reminder";
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        //self.backButton.backgroundColor = kDefConfirmColor;
        [self addSubview:self.backButton];
        //////////////////create switch////////////////////////////////////////////////
       
        self.onoff = [[UISwitch alloc] initWithFrame: CGRectMake(self.bounds.size.width-kBackMargin-switchWidth-3, self.bounds.size.height-switchHeight-kBackMargin+13, switchWidth, switchHeight)];
        self.onoff.autoresizingMask = (UIViewAutoresizingFlexibleRightMargin|UIViewAutoresizingFlexibleTopMargin);
        self.onoff.on = true;
        //self.onoff.backgroundColor = kDefConfirmColor;
