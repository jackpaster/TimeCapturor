...
- (id)initWithPoint:(CGPoint)point radius:(int)radiusValue inView:(UIView *)inView
{
    ...
    if (self) {
        ...
        self.SinaBackgroundColorRGB = 0xE6162D;
...
-(void)show
{
    if(!self.isAnimating)
    {
        ...
        if(self.showMessageBubble)     [self createButtonWithIcon:@"Message.png" backgroundColor:self.MessageBackgroundColorRGB andType:AAShareBubbleTypeMessage];
        if(self.showQQBubble)     [self createButtonWithIcon:@"QQ.png" backgroundColor:self.QQBackgroundColorRGB andType:AAShareBubbleTypeQQ];
       if(self.showQzoneBubble)     [self createButtonWithIcon:@"Qzone.png" backgroundColor:self.QzoneBackgroundColorRGB andType:AAShareBubbleTypeQzone];
        if(self.showSinaBubble)     [self createButtonWithIcon:@"Sina.png" backgroundColor:self.SinaBackgroundColorRGB andType:AAShareBubbleTypeSina];
        if(self.showWechatBubble)     [self createButtonWithIcon:@"Wechat.png" backgroundColor:self.WechatBackgroundColorRGB andType:AAShareBubbleTypeWechat];
