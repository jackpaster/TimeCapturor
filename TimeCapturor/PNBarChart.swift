...
public class PNBarChart: UIView {
    ...
    */
    ...
    /*
    chartMargin changes chart margin 15.0
    */
    public var chartMargin:CGFloat = 23.0
    ...
    */
    public var barRadius:CGFloat = 3
    ...
    */
    public var barBackgroundColor:UIColor = PNGreyColor
    ...
    */
    ...
    public  func strokeChart() {
        ...
        for valueObj: AnyObject in yValues{
            ...
            if(value<=1){
                bar.barColor = UIColor(red: 149/255.0, green: 165/255.0, blue: 166/255.0, alpha: 1)//rgb(149, 165, 166)
            }
